...
function Band({ maxSpeed = 50, minSpeed = 0 }) {
  ...
  const profileTexture = useTexture(rafiImage);
  
  // --- SETTING TEXTURE (DIPERBARUI) ---
  
  profileTexture.flipY = false; 
  profileTexture.center.set(0.5, 0.5);

  // Scale (Zoom)
  profileTexture.repeat.set(1.1, 1.1); 

  // GESER POSISI (Offset)
  // Tadi 0.15 masih kurang ke kiri.
  // Sekarang kita ubah jadi 0.28 agar geser drastis ke kiri.
  profileTexture.offset.set(0.28, 0.05); 
